...
<head>
  ...
  <title><?php echo $sitehead ?> | Delete</title>
       ...
       <ul class="sidebar-menu" data-widget="tree">
		...
		<li class="treeview">
          ...
          <ul class="treeview-menu">
            <li ><a href="registernode.php"> <i class="fa fa-desktop"></i> <span>Register Node</span></a></li>
			<li ><a href="registerswitch.php"> <i class="fa fa-hand-pointer-o"></i> <span>Register Switch</span></a></li>
          </ul>
        </li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Delete Device</li>
      </ol>
    </section>
          ...
          <div class="box box-solid"> 
            <div class="box-body">
              <div id='fg_membersite_content'>
				<h2 >Success</h2>
				You have successfully deleted your node/switch.
				</div>
            </div>
            <!-- /.box-body -->
          </div>
