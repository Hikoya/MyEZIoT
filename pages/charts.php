<?php 
	...
	if(mysqli_num_rows($tab_result) > 0)
	{
		...
		while($row = mysqli_fetch_array($tab_result))
		{
			...
			$select_content .= '<option value="'.$row["gatewayno"].'">'.$row["description"].'</option>';
...
if(isset($_POST['submitted']))
{
	if(!empty($_POST['serialno']))
	{
		...
		header('Content-Disposition: attachment; filename="'.$_POST['serialno'].'.csv"');
		...
		fputcsv($file, array('Column 1', 'Column 2', 'Column 3', 'Column 4', 'Column 5' , 'Timestamp'));
 
		
		$csv_sql = "SELECT column1, column2, column3, column4, column5 , timestamp FROM " . $_POST['serialno'] . " ";
		if($csv_result = mysqli_query($connect, $csv_sql)){
		...
		<div class="col-lg-5 col-xs-12">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
				...
				<form id='csv' style="margin-left:10px" class="form-horizontal" onsubmit="return validateForm()" action='<?php echo $fgmembersite->GetSelfScript(); ?>' method='post' accept-charset='UTF-8' role="form">
				...
				<div class="form-group">
				  ...
				  <div class="col-lg-7">
					<div class = "select-style" style="width:100px" >
			  ...
			  <div class="form-group">
				...
				<div class="col-md-3">
				  <button type="submit" class="btn btn-primary" style="width:100px" name="submitted" id="submitted">Export</button>
				  <span></span>
				</div>
...
if($is_present == 1)
{
	...
	function validateForm() {
		...
		var x = document.forms["csv"]["serialno"].value;
		if (x == "") {
